...
export default function QuizPage() {
  ...
  const handleAnswer = useCallback(
    async (optionId: string) => {
      ...
      setAnswered(true);
      try {
        const data: any = await api.submitAnswer(
          session.attemptId,
          question.id,
          optionId,
        );
  ...
  const handlePrev = useCallback(async () => {
    ...
    try {
      ...
      if (d.previously_selected_option) {
        ...
        setAnswered(true);
        setFeedback({
          isCorrect: p.was_correct,
          msg: p.was_correct ? "✓ Correct!" : "✗ Wrong",
          explanation: null,
          correctId: null,
          correctText: null,
          selectedId: p.option_id,
          remaining: 0,
          isPrev: true,
        });
      } else {
    ...
    >
      ...
      >
        ...
        >
          <div
            style={{
              height: "100%",
              background: "linear-gradient(90deg,#FF6D00,#F50057,#651FFF)",
      ...
      >
        ...
        <div
          ...
          style={{ padding: "30px 28px 24px", marginBottom: 18 }}
        >
          <span
            style={{
              display: "inline-block",
              marginBottom: 14,
              background: "rgba(101,31,255,.25)",
              border: "1px solid rgba(101,31,255,.4)",
              color: "#C5B8FF",
              fontSize: 12,
              fontWeight: 700,
              padding: "4px 14px",
          ...
          <div
            ...
            style={{
              ...
              background: feedback.isCorrect
                ? "rgba(0,200,83,.1)"
                : "rgba(245,0,87,.1)",
              border: `1px solid ${feedback.isCorrect ? "rgba(0,200,83,.3)" : "rgba(245,0,87,.3)"}`,
            }}
          >
            ...
            <div>
              <p
                style={{
                  ...
                  fontWeight: 700,
                  marginBottom: 4,
                  color: feedback.isCorrect ? "#69F0AE" : "#FF80AB",
                }}
              >
                {feedback.msg}
              </p>
