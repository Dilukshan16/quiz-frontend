...
export default function ResultsPage() {
  ...
  if (error || !results)
    return (
      ...
      >
        <p style={{ color: "#F50057", fontWeight: 700, maxWidth: 300 }}>
          {error}
        </p>
  ...
  return (
    <div
      style={{
        ...
        position: "relative",
        background:
          "linear-gradient(160deg, #0A0015 0%, #12001F 50%, #1A0030 100%)",
      }}
    >
      <div className="orbs">
        <div
        ...
        >
          ...
          >
            {[1, 2, 3].map((n) => (
              <span
                ...
                style={{
                  fontSize: 50,
                  opacity: n <= starsShown ? 1 : 0.2,
                  filter: n <= starsShown ? "none" : "grayscale(1)",
                  animation:
                    n <= starsShown
                      ? `starPop .5s ease ${0.7 + n * 0.28}s both`
                      : "none",
          ...
          <div
            style={{
              ...
              width: "fit-content",
              margin: "0 auto 28px",
              boxShadow: "0 6px 24px rgba(255,109,0,.35)",
            }}
          >
            {results.badge}
          </div>
          ...
          >
            {[
              ...
              {
                label: "Wrong",
                value: results.incorrect_answers,
                color: "#F50057",
              },
              ...
              {results.answer_review.map((a, i) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "14px 16px",
                    marginBottom: 10,
                    border: `1px solid ${a.is_correct ? "rgba(0,200,83,.25)" : "rgba(245,0,87,.25)"}`,
                ...
                >
                  ...
                  >
                    <span
                      style={{ color: a.is_correct ? "#69F0AE" : "#FF80AB" }}
                    >
                      {a.is_correct ? "✓" : "✗"} You: {a.selected_option_text}
                    </span>
                    {!a.is_correct && (
                      <span style={{ color: "#69F0AE" }}>
                        ✓ Correct: {a.correct_option_text}
                      </span>
                    )}
                  </div>
                  {a.explanation && (
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            <button
              ...
              style={{ flex: 1, padding: 16, fontSize: 15 }}
              onClick={() => router.push("/")}
            >
              🏠 Home
            </button>
